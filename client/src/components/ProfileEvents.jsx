    ...
    <>
      <div className="profile-events ">
        <div className="profile-events-container">
          <div className="flex flex-col gap-2 items-center justify-center h-[365px] w-[365px] bg-none border border-dashed rounded-md cursor-pointer" onClick={openModal}>
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
              <path d="M24 30V24M24 24V18M24 24H18M24 24H30M24 42C18.4087 42 15.6131 42 13.4078 41.0866C10.4675 39.8686 8.13137 37.5325 6.91345 34.5922C6 32.3869 6 29.5913 6 24C6 18.4087 6 15.6131 6.91345 13.4078C8.13137 10.4675 10.4675 8.13137 13.4078 6.91345C15.6131 6 18.4087 6 24 6C29.5913 6 32.3869 6 34.5922 6.91345C37.5325 8.13137 39.8686 10.4675 41.0866 13.4078C42 15.6131 42 18.4087 42 24C42 29.5913 42 32.3869 41.0866 34.5922C39.8686 37.5325 37.5325 39.8686 34.5922 41.0866C32.3869 42 29.5913 42 24 42Z" stroke="#71706C" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
